...
from src.Qnetwork2 import dqnModel2
...
def main():
    ParBatch=[64,128,256]
    ParWidth=[32,64,128]
    ParLR=[0.0001,0.0005,0.001]
    for I in ParBatch:
        for J in ParWidth:
            for K in ParLR:
                if I==64 and J==32 and K==0.0001:
                    continue
                paramSet = {
                    'INITIAL_EPSILON': 0.4,
                    'FINAL_EPSILON': 0.01,
                ...
                TEST_PLOT = 200 # Plot while training
                ...
                for episode in range(EPISODE):
                    ...
                    if episode == EPISODE-1:
                        ...
                        for i in range(TEST):
                            ...
                            if rewards>=1.25:
                                count+=1
                        print("batch={},width={},lr={},count={}".format(I,J,K,count))
                print(results)
