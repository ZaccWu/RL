...
if Choose=='TSA':
    ...
    plt.title('hidden layer=2x240, batch size=256', fontdict={'family' : 'Times New Roman', 'size':4})
...
if Choose=='PRF':
    ...
    plt.title('The frequency of reaching 125 steps with 2 hidden layers (batchsize=64)', fontdict={'family' : 'Times New Roman', 'size':4})
