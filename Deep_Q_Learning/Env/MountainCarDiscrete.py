...
class resetMtCarDiscrete:
    def __init__(self, low =-0.6, high=-0.4):
        self.seed()
        self.low = low
        self.high = high
    ...
    def __call__(self):
        ...
        state = np.array([self.np_random.uniform(self.low, self.high), 0])
